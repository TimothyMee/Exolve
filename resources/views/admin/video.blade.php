    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components ml-4">
            ...
            <li>
                ...
                <a href="{{route('admin.videos')}}" class="text-white active"><span><img class="pr-4 pb-1" src="/img/time-left.png"></span> Videos</a>
            </li>
        </ul>
    </nav>
                                ...
                                @foreach($videos as $video)
                                    <div class="col-md-4 my-3">
                                        ...
                                        <div class="">
                                            ...
                                            <a href="/admin/video/approve/{{$video['id']}}"><button class="btn btn-dark py-0 px-3 rounded-0">Approve</button></a>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
