...
<div class="wrapper b_img">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components ml-4">
            ...
            <li>
                <a href="{{route('pending-video')}}" class="text-white active"><span><img class="pr-4 pb-1" src="/img/time-left.png" alt="pending" ></span> Pending</a>
            </li>
            <li>
                        ...
                        <div class="col-md-4 my-3">
                            ...
                            <div class="">
                                ...
                                @if($video['status'] == "pending")
                                    <button class="btn btn-def py-0 px-3 rounded-0" disabled>Awaiting Approval</button>
                                @else
                                     <button class="btn btn-dark py-0 px-3 rounded-0" disabled>Approved</button>
                                @endif
                            </div>
                        </div>
                        @endforeach
